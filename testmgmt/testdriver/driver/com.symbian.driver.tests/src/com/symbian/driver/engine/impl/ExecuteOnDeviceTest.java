...
import com.symbian.driver.core.controller.tasks.IExecuteOnDevice;
...
public class ExecuteOnDeviceTest extends TestCase {
	...
	/** Test method for {@link com.symbian.driver.core.controller.tasks.IExecuteOnHost#doTask(boolean, int, boolean)}. */
	public final void testCreateRemoveFolderListDrives() {		
		try {
			...
			if (!Utils.readBuffer(lBufferedReader, new String[] {EngineTests.SYMBIAN_DIR, Integer.toString(IExecute.STATOK)})) {
				fail();
			}
	...
	public final void testRunPollKillSyncBeforeTimeout() {
		try {		
			final IExecuteOnDevice lExecuteOnDevice = iExecuteFactory.createExecuteOnDevice(JStat.RUN, "agenda.exe");
	...
	public final void testSendRetrieveDeleteListFile() {
		try {
			...
			lBufferedReader = Utils.executeOnDevice(JStat.LIST_FILES, EngineTests.SYMBIAN_C, null);
			if (!Utils.readBuffer(lBufferedReader, new String[] {EngineTests.SYMBIAN_FILE_1, Integer.toString(IExecute.STATOK)})) {
				fail();
			}
