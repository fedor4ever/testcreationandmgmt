...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Tef Test Step Summary</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * <ul>
 *   <li>{@link com.symbian.driver.report.impl.TefTestStepSummaryImpl#getTestCase <em>Test Case</em>}</li>
 *   <li>{@link com.symbian.driver.report.impl.TefTestStepSummaryImpl#getAbort <em>Abort</em>}</li>
 *   <li>{@link com.symbian.driver.report.impl.TefTestStepSummaryImpl#getCount <em>Count</em>}</li>
 *   <li>{@link com.symbian.driver.report.impl.TefTestStepSummaryImpl#getFail <em>Fail</em>}</li>
 *   <li>{@link com.symbian.driver.report.impl.TefTestStepSummaryImpl#getInconclusive <em>Inconclusive</em>}</li>
 *   <li>{@link com.symbian.driver.report.impl.TefTestStepSummaryImpl#getPanic <em>Panic</em>}</li>
 *   <li>{@link com.symbian.driver.report.impl.TefTestStepSummaryImpl#getPass <em>Pass</em>}</li>
 *   <li>{@link com.symbian.driver.report.impl.TefTestStepSummaryImpl#getUnexecuted <em>Unexecuted</em>}</li>
 *   <li>{@link com.symbian.driver.report.impl.TefTestStepSummaryImpl#getUnknown <em>Unknown</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public class TefTestStepSummaryImpl extends EObjectImpl implements TefTestStepSummary {
	/**
	 ...
	 * @generated
	 */
	protected TefTestStepSummaryImpl() {
		super();
	}
	...
	protected EClass eStaticClass() {
		return ReportPackage.Literals.TEF_TEST_STEP_SUMMARY;
	}
	...
	public EList getTestCase() {
		if (testCase == null) {
			testCase = new EObjectContainmentEList(TefTestStep.class, this, ReportPackage.TEF_TEST_STEP_SUMMARY__TEST_CASE);
		}
		return testCase;
	}
	...
	public void setAbort(int newAbort) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ReportPackage.TEF_TEST_STEP_SUMMARY__ABORT, oldAbort, abort, !oldAbortESet));
	}
	...
	public void unsetAbort() {
		...
		abortESet = false;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, ReportPackage.TEF_TEST_STEP_SUMMARY__ABORT, oldAbort, ABORT_EDEFAULT, oldAbortESet));
	}
	...
	public void setCount(int newCount) {
		...
		countESet = true;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ReportPackage.TEF_TEST_STEP_SUMMARY__COUNT, oldCount, count, !oldCountESet));
	}
	...
	public void unsetCount() {
		...
		countESet = false;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, ReportPackage.TEF_TEST_STEP_SUMMARY__COUNT, oldCount, COUNT_EDEFAULT, oldCountESet));
	}
	...
	public void setFail(int newFail) {
		...
		failESet = true;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ReportPackage.TEF_TEST_STEP_SUMMARY__FAIL, oldFail, fail, !oldFailESet));
	}
	...
	public void unsetFail() {
		...
		failESet = false;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, ReportPackage.TEF_TEST_STEP_SUMMARY__FAIL, oldFail, FAIL_EDEFAULT, oldFailESet));
	}
	...
	public void setInconclusive(int newInconclusive) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ReportPackage.TEF_TEST_STEP_SUMMARY__INCONCLUSIVE, oldInconclusive, inconclusive, !oldInconclusiveESet));
	}
	...
	public void unsetInconclusive() {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, ReportPackage.TEF_TEST_STEP_SUMMARY__INCONCLUSIVE, oldInconclusive, INCONCLUSIVE_EDEFAULT, oldInconclusiveESet));
	}
	...
	public void setPanic(int newPanic) {
		...
		panicESet = true;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ReportPackage.TEF_TEST_STEP_SUMMARY__PANIC, oldPanic, panic, !oldPanicESet));
	}
	...
	public void unsetPanic() {
		...
		panicESet = false;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, ReportPackage.TEF_TEST_STEP_SUMMARY__PANIC, oldPanic, PANIC_EDEFAULT, oldPanicESet));
	}
	...
	public void setPass(int newPass) {
		...
		passESet = true;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ReportPackage.TEF_TEST_STEP_SUMMARY__PASS, oldPass, pass, !oldPassESet));
	}
	...
	public void unsetPass() {
		...
		passESet = false;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, ReportPackage.TEF_TEST_STEP_SUMMARY__PASS, oldPass, PASS_EDEFAULT, oldPassESet));
	}
	...
	public void setUnexecuted(int newUnexecuted) {
		...
		unexecutedESet = true;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ReportPackage.TEF_TEST_STEP_SUMMARY__UNEXECUTED, oldUnexecuted, unexecuted, !oldUnexecutedESet));
	}
	...
	public void unsetUnexecuted() {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, ReportPackage.TEF_TEST_STEP_SUMMARY__UNEXECUTED, oldUnexecuted, UNEXECUTED_EDEFAULT, oldUnexecutedESet));
	}
	...
	public void setUnknown(int newUnknown) {
		...
		unknownESet = true;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ReportPackage.TEF_TEST_STEP_SUMMARY__UNKNOWN, oldUnknown, unknown, !oldUnknownESet));
	}
	...
	public void unsetUnknown() {
		...
		unknownESet = false;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, ReportPackage.TEF_TEST_STEP_SUMMARY__UNKNOWN, oldUnknown, UNKNOWN_EDEFAULT, oldUnknownESet));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case ReportPackage.TEF_TEST_STEP_SUMMARY__TEST_CASE:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case ReportPackage.TEF_TEST_STEP_SUMMARY__TEST_CASE:
				return getTestCase();
			case ReportPackage.TEF_TEST_STEP_SUMMARY__ABORT:
				return new Integer(getAbort());
			case ReportPackage.TEF_TEST_STEP_SUMMARY__COUNT:
				return new Integer(getCount());
			case ReportPackage.TEF_TEST_STEP_SUMMARY__FAIL:
				return new Integer(getFail());
			case ReportPackage.TEF_TEST_STEP_SUMMARY__INCONCLUSIVE:
				return new Integer(getInconclusive());
			case ReportPackage.TEF_TEST_STEP_SUMMARY__PANIC:
				return new Integer(getPanic());
			case ReportPackage.TEF_TEST_STEP_SUMMARY__PASS:
				return new Integer(getPass());
			case ReportPackage.TEF_TEST_STEP_SUMMARY__UNEXECUTED:
				return new Integer(getUnexecuted());
			case ReportPackage.TEF_TEST_STEP_SUMMARY__UNKNOWN:
