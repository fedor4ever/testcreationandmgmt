...
class CMessengerSuite : public CBase
  	{
public:
		// Construction
	IMPORT_C static CMessengerSuite* NewLC(CConsoleBase& aConsole, const TDesC& aString);
...
private:
	...
	CMessengerSuite(CConsoleBase& aConsole);
