 ...
 */
public class GetItemPagesProvider implements IExtraPagesProvider {

	private GenerateUnitFromPage iGenerateUnitFromPage;

	private GetTestableItemsUnitPage iGetTestableItemsUnitPage;
	...
	public List<IWizardDataPage> getPages(IWorkbenchWizard aWorkbenchWizard) {
		...
		lWizardDataPageList.add(iGenerateUnitFromPage);

		lWizardDataPageList.add(iGetTestableItemsUnitPage);
	 ...
	 */
	public void init(IWorkbenchWizard aWorkbenchWizard, IWorkbench aWorkbench,
			IStructuredSelection aStructuredSelection) {
		iGenerateUnitFromPage = new GenerateUnitFromPage();
		iGetTestableItemsUnitPage = new GetTestableItemsUnitPage();
	}
}
