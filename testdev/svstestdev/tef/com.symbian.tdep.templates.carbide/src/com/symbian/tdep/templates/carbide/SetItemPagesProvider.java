 ...
 */
public class SetItemPagesProvider implements IExtraPagesProvider {

	private SetTestableItemsPage iTestableItemsPage;
	...
	public List<IWizardDataPage> getPages(IWorkbenchWizard aWorkbenchWizard) {
		...
		lWizardDataPageList.add(iTestableItemsPage);
	...
	public void init(IWorkbenchWizard aWorkbenchWizard, IWorkbench aWorkbench,
		...
		iTestableItemsPage = new SetTestableItemsPage();
	}
}
