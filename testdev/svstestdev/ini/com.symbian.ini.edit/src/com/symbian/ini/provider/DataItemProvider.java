...
/**
 * This is the item provider adapter for a {@link com.symbian.ini.Data} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class DataItemProvider
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Data_key_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Data_key_feature", "_UI_Data_type"),
				 IniPackage.Literals.DATA__KEY,
				 true,
				 false,
				 false,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 IniPackage.Literals.DATA__VALUE,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	public String getText(Object object) {
		String label = ((Data)object).getKey();
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(Data.class)) {
			case IniPackage.DATA__KEY:
			case IniPackage.DATA__VALUE:
