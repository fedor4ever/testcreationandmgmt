 ...
 * @generated
 */
public class CommentAdapterFactory extends AdapterFactoryImpl {
	/**
	 ...
	 * @generated
	 */
	protected CommentSwitch<Adapter> modelSwitch =
		new CommentSwitch<Adapter>() {
			@Override
			public Adapter caseComment(Comment object) {
				return createCommentAdapter();
			}
			@Override
			public Adapter caseCommentTag(Map.Entry<String, String> object) {
				return createCommentTagAdapter();
			}
			@Override
	 ...
	 * @generated
	 */
	public Adapter createCommentTagAdapter() {
		return null;
	}
