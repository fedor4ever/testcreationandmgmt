...
/**
 * This is the item provider adapter for a {@link com.symbian.driver.TestCase} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class TestCaseItemProvider
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_TestCase_target_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_TestCase_target_feature", "_UI_TestCase_type"),
				 DriverPackage.Literals.TEST_CASE__TARGET,
				 true,
				 false,
				 false,
	...
	public String getText(Object object) {
		String label = ((TestCase)object).getTarget();
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(TestCase.class)) {
			case DriverPackage.TEST_CASE__TARGET:
