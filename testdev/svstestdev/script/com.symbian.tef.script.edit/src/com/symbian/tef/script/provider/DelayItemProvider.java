...
/**
 * This is the item provider adapter for a {@link com.symbian.tef.script.Delay} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class DelayItemProvider
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Delay_timeout_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Delay_timeout_feature", "_UI_Delay_type"),
				 ScriptPackage.Literals.DELAY__TIMEOUT,
				 true,
				 false,
				 false,
	...
	public String getText(Object object) {
		...
		return getString("_UI_Delay_type") + " " + delay.getTimeout();
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(Delay.class)) {
			case ScriptPackage.DELAY__TIMEOUT:
