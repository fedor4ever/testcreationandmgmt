...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Load Server</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * <ul>
 *   <li>{@link com.symbian.tef.script.impl.LoadServerImpl#getServer <em>Server</em>}</li>
 *   <li>{@link com.symbian.tef.script.impl.LoadServerImpl#isSharedData <em>Shared Data</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public class LoadServerImpl extends EObjectImpl implements LoadServer {
	/**
	...
	protected EClass eStaticClass() {
		return ScriptPackage.Literals.LOAD_SERVER;
	}
	...
	public void setServer(String newServer) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ScriptPackage.LOAD_SERVER__SERVER, oldServer, server));
	}
	...
	public void setSharedData(boolean newSharedData) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ScriptPackage.LOAD_SERVER__SHARED_DATA, oldSharedData, sharedData));
	}
