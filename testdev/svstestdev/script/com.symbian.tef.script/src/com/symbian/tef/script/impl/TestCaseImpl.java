 ...
 * <ul>
 *   <li>{@link com.symbian.tef.script.impl.TestCaseImpl#getTef <em>Tef</em>}</li>
 *   <li>{@link com.symbian.tef.script.impl.TestCaseImpl#getName <em>Name</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public class TestCaseImpl extends AttachedCommentImpl implements TestCase {
	/**
	...
	protected EClass eStaticClass() {
		return ScriptPackage.Literals.TEST_CASE;
	}
	...
	public EList<Tef> getTef() {
		if (tef == null) {
			tef = new EObjectContainmentEList<Tef>(Tef.class, this, ScriptPackage.TEST_CASE__TEF);
		}
		return tef;
	}
	...
	public void setName(String newName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ScriptPackage.TEST_CASE__NAME, oldName, name));
	}
	...
	public int eBaseStructuralFeatureID(int derivedFeatureID, Class<?> baseClass) {
		...
		if (baseClass == Container.class) {
			switch (derivedFeatureID) {
				case ScriptPackage.TEST_CASE__TEF: return ScriptPackage.CONTAINER__TEF;
				default: return -1;
			}
		}
	...
	public int eDerivedStructuralFeatureID(int baseFeatureID, Class<?> baseClass) {
		...
		if (baseClass == Container.class) {
			switch (baseFeatureID) {
				case ScriptPackage.CONTAINER__TEF: return ScriptPackage.TEST_CASE__TEF;
				default: return -1;
			}
		}
