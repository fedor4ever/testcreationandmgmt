...
import com.symbian.tef.script.util.ScriptResourceFactoryImpl;
...
/**
 * <!-- begin-user-doc -->
 * A sample utility for the '<em><b>script</b></em>' package.
 * <!-- end-user-doc -->
 * @generated
 */
	...
	public static void main(String[] args) {
		...
		if (args.length == 0) {
			...
			try {
				...
				TefModel root = ScriptFactory.eINSTANCE.createTefModel();
