...
/**
 * <!-- begin-user-doc -->
 * A sample utility for the '<em><b>ini</b></em>' package.
 * <!-- end-user-doc -->
 * @generated
 */
public class IniExample {
	...
	public static void main(String[] args) {
		...
		if (args.length == 0) {
			...
			try {
				Resource resource = resourceSet.createResource(URI.createURI("http:///My.ini"));
				IniModel root = IniFactory.eINSTANCE.createIniModel();
